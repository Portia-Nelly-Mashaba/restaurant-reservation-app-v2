...
const RestaurantMenuListView = () => {
  ...
  const renderRestaurantItem = ({ item }) => (
    <TouchableOpacity
      style={styles.card}
      onPress={() => navigation.navigate('Restaurant Menu', { restaurantId: item.id })}  // Navigate to RestaurantMenu with restaurant id
    >
...
export default RestaurantMenuListView;
